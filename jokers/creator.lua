SMODS.Joker {
    ...
    calculate = function (self, card, context)
        ...
        if context.scoring_hand and context.scoring_hand[1] and not context.scoring_hand[1].debuff and context.after and G.GAME.current_round.hands_played == 0 then
